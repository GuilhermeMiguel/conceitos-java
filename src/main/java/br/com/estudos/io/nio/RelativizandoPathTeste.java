package br.com.estudos.io.nio;

import java.nio.file.Path;
import java.nio.file.Paths;

public class RelativizandoPathTeste {

	public static void main(String[] args) {
		Path dir = Paths.get("/home/william");
		Path classe = Paths.get("/home/william/java/Pessoa.java");
		Path pathToClasse = dir.relativize(classe); //Pega o que e relativo
		...
		System.out.println("5: " + absoluto1.relativize(relativo1)); //Não tem como montar um relativo entre os dois
